...
### 주요 기능
1. **선용품 카테고리 분류 및 리드타임 예측 서비스**
   - **카테고리 분류:** 선용품 등록 시 추천 카테고리 분류를 통한 등록 지원.
   - **리드타임 예측:** 다양한 선용품의 리드타임을 예측하여 최적의 발주 시점을 제안. 이를 통해 보관 및 운영 비용 최소화.
...
- **IDE:** STS4
- **데이터베이스:** MySQL 8.0.37
- **기계학습 / 딥러닝:** BERT, BertTransformer, XGBClassifier, LightGBMregressor
